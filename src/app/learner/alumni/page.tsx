 ...
 *
 * These are demo records, like the seeded learners. Nobody here is real, and
 * the LinkedIn mark is a badge on the card, not a link to an account. The real
 * repository is a page on the main site, and the header's CTA goes there.
 */
...
export default function LearnerAlumniPage() {
  ...
  return (
    <UpgradShell user={user} section="alumni" appId={app?.id ?? null}>
      ...
      <div className="scroll-quiet mt-4 max-h-[620px] overflow-y-auto">
