...
import { signeesFor } from "@/lib/documents";
...
export default function LearnerApplicationPage({
  ...
  // Documents left the application for a section of its own. Old links —
  // bookmarks, and the "please re-upload" notification — still land on them.
  if (searchParams.tab === "documents" || searchParams.tab === "docs")
  ...
  return (
    <UpgradShell user={user} section="application" appId={app.id}>
      <Link
